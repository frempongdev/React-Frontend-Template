...
import { handleUpdate, logInUser, toggleFormAuth } from "../redux/slices/AuthSlice"
...
const LoginForm = () => {
    ...
    return (
        <section className="flex flex-col md:flex-row h-[100vh] max-w-[1440px] mx-auto items-center">
            ...
            <div className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12 flex items-center justify-center">
                <div className="w-full h-100">
                    ...
                    <form className="mt-6" action="#" method="POST" onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <div className="mt-4">
                            <label className=" text-gray-700 hidden" >Password</label>
                            <input
                                type="password"
                                name="password"
